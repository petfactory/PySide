...
a = Analysis(['png_comp.py'],
             ...
             binaries=None,
             datas=[('assets/03 bg/bg.png', './assets/03 bg/'),
                    ('assets/02 body/body_1.png', './assets/02 body/'),
                    ('assets/02 body/body_2.png', './assets/02 body/'),
                    ('assets/02 body/body_3.png', './assets/02 body/'),
                    ('assets/01 wheels/wheels_1.png', './assets/01 wheels/'),
                    ('assets/01 wheels/wheels_2.png', './assets/01 wheels/'),
                    ('assets/01 wheels/wheels_3.png', './assets/01 wheels/'),
                    ('up_arrow.png', '.'),
                    ('down_arrow.png', '.'),
                    ('open_dir.png', '.')],
             hiddenimports=[],
